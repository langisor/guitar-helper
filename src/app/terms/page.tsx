...
import TermsContent from "@/chords/components/what-is/terms";
...
export default function TermsPage() {
  ...
  return (
    <WhatIsDrawer
      drawerTitle="Music Terms Glossary"
      drawerDescription="Learn how to use the glossary and why music terminology matters"
      buttonLabel="What's Glossary"
      drawerContent={<TermsContent />}
    >
